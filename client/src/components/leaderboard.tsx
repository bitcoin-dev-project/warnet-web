...
const Leaderboard = ({ teamPoints, awardedPoints }: LeaderboardProps) => {
  ...
  return (
    <section className="flex flex-col gap-4 rounded-lg w-full text-black dark:text-white">
      ...
      <section className="flex flex-col gap-6 px-4 py-2 rounded-lg overflow-y-scroll border border-neutral-800 bg-zinc-800/30 from-inherit bg-gradient-to-b backdrop-blur-2xl h-full">
